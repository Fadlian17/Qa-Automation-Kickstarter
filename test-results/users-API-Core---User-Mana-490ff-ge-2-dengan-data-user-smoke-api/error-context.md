...
- Name: api-tests/users.spec.ts >> API Core - User Management @regression >> GET list user - should return page 2 dengan data user @smoke
- Location: api-tests/users.spec.ts:11:7
